VODDetail = (function (Events) {
    ...
    $.extend(true, VODDetail, Events, {
		...
		setVodContent: function(vod) {
			...
			img = img == null || img.length == 0 ? baseUrl + "/cv_data_pub/images/" + vod.image1Id + "/v/original.jpg" : img;
			img = img == null || img.length == 0 ? baseUrl + "/cv_data_pub/images/" + vod.image2Id + "/v/original.jpg" : img;
			img = img == null || img.length == 0 ? baseUrl + "/cv_data_pub/images/" + vod.image3Id + "/v/original.jpg" : img;
